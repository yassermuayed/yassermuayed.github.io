...
![SVG Document](../../images/svg_doc.svg)
...
The `<path>` element can be used to create any kind of shape. In other words it is the only element you need to draw.
